package org.asura.rabbitmq.producer;

import org.asura.rabbitmq.producer.entity.User;
...
public class AsuraRabbitmqProducerApplication {

	public static void main(String[] args) {
		ConfigurableApplicationContext applicationContext = SpringApplication.run(AsuraRabbitmqProducerApplication.class, args);
