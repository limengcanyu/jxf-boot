package com.spring.boot.i18n.aspect;

import com.spring.boot.i18n.enums.BusinessStatusEnum;
import com.spring.boot.i18n.enums.BusinessTypeEnum;
import com.spring.boot.i18n.enums.CommonErrorEnum;
import com.spring.boot.i18n.enums.I18nEnum;
...
public class I18nMonitorAspect implements ApplicationRunner {
     ...
     * 监控国际化解析方法耗时
     */
    @Around("execution(* com.spring.boot.i18n.utils.I18nEnumUtils.getDesc(..)) || " +
            "execution(* com.spring.boot.i18n.enums.I18nEnum.getDesc(..))")
