...
| [execute-workflow-demo.sh](./execute-workflow-demo.sh) | 完整功能演示脚本 | 学习工作流、功能验证 |
| [simple-test-api.sh](./simple-test-api.sh) | 简化API测试脚本 | 基础测试、日常验证 |
...
### 👨‍💻 开发人员
1. **首次接触项目**: [README.md](./README.md) → [execute-workflow-demo.sh](./execute-workflow-demo.sh)
...
3. **健康检查**: [simple-test-api.sh](./simple-test-api.sh)

### 🧪 测试人员
1. **功能测试**: [API_TESTING.md](./API_TESTING.md)
2. **自动化测试**: [execute-workflow-demo.sh](./execute-workflow-demo.sh)
3. **问题诊断**: [TROUBLESHOOTING.md](./TROUBLESHOOTING.md)

### 📋 项目经理
1. **项目概览**: [README.md](./README.md)
2. **功能演示**: [execute-workflow-demo.sh](./execute-workflow-demo.sh)
