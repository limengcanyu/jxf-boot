...
public class EclipseJavaFormatter {
    ...
    public static void main(String[] args) {
        // 测试用的混乱代码
        String messyCode = "public class Test{public static void main(String[] args){String msg=\"hello world\";System.out.println(msg);}}";

        // 格式化并打印结果
        String formattedCode = formatJavaCode(messyCode);
        System.out.println("格式化后的代码（无前置空格）：\n" + formattedCode);
    }
}
