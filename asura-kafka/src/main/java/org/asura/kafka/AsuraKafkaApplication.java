...
import org.asura.kafka.entity.User;
...
public class AsuraKafkaApplication implements CommandLineRunner {

    public static Logger logger = LoggerFactory.getLogger(AsuraKafkaApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(AsuraKafkaApplication.class, args);
    }
