...
public class MybatisPlusCodeGenerator {
    public static void main(String[] args) {
        ...
        String modulePath = "/spring-boot-hole";

        String url = "jdbc:mysql://localhost:3306/hole?useUnicode=true&characterEncoding=utf8&allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=Asia/Shanghai";
        String driverName = "com.mysql.cj.jdbc.Driver";
        String username = "root";
        String password = ".PassW0rd,321";

        String parentPackageName = "com.spring.boot.hole";
...
//        strategy.setSuperEntityColumns("id", "creatorId", "createTime", "modifierId", "modifyTime", "version");
        strategy.setInclude("example_table");
