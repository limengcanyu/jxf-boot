package org.asura.mybatisplus.druid.dynamic.datasource;
...
public class AsuraDruidDynamicDatasourceApplication {
    public static void main(String[] args) {
        ApplicationContext ctx = SpringApplication.run(AsuraDruidDynamicDatasourceApplication.class);
