package org.asura.multi.datasource.transaction.aop;
...
//        def.setName("SomeTxName");
    ...
    @Pointcut("@annotation(org.asura.multi.datasource.transaction.annotation.MultiTransactional)")
    public void pointcut() {
    }

    @Around("@annotation(org.asura.multi.datasource.transaction.annotation.MultiTransactional)")
