package org.asura.shardingsphere.jdbc.preciseAlgorithm;
...
@Slf4j
public class TOrderShardingUtils {
    /**
    ...
    public static String preciseSharding(Collection<String> availableTargetNames, PreciseShardingValue<LocalDateTime> shardingValue) {
        ...
        String tablePattern = "t_order_create_time_YEAR_qDU".replace("YEAR", year + "");
