package com.spring.boot.rocketmq.acl.produce;
...
public class SpringBootRocketmqAclProduceApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpringBootRocketmqAclProduceApplication.class, args);
    }
