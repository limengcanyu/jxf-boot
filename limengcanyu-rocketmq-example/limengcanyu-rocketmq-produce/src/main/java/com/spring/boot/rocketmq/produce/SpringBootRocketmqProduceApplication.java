...
import com.spring.boot.rocketmq.produce.domain.OrderPaidEvent;
import com.spring.boot.rocketmq.produce.domain.ProductWithPayload;
import com.spring.boot.rocketmq.produce.domain.User;
...
public class SpringBootRocketmqProduceApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpringBootRocketmqProduceApplication.class, args);
    }
