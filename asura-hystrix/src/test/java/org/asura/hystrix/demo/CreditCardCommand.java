 ...
 */
public class CreditCardCommand extends HystrixCommand<com.netflix.hystrix.examples.demo.CreditCardAuthorizationResult> {
     ...
     */
    @Override
    protected com.netflix.hystrix.examples.demo.CreditCardAuthorizationResult run() {
        ...
        if (result.isApproved()) {
            return com.netflix.hystrix.examples.demo.CreditCardAuthorizationResult.createSuccessResponse(result.getTarget().getTransactionId(), result.getTarget().getAuthorizationCode());
        } else if (result.isDeclined()) {
            return com.netflix.hystrix.examples.demo.CreditCardAuthorizationResult.createFailedResponse(result.getReasonResponseCode() + " : " + result.getResponseText());
        } else {
            ...
            if (result.getReasonResponseCode().getResponseReasonCode() == 11) {
                if (result.getTarget().getAuthorizationCode() != null) {
                    ...
                    return com.netflix.hystrix.examples.demo.CreditCardAuthorizationResult.createDuplicateSuccessResponse(result.getTarget().getTransactionId(), result.getTarget().getAuthorizationCode());
                }
            }
