package org.asura.jwt.constant;
...
public class JwtConst {
    ...
    public static final long TOKEN_EXPIRE_TIME = 5 * 60 * 1000L; // token过期时间
    public static final long REFRESH_TOKEN_EXPIRE_TIME = 10 * 60 * 1000L; // refresh Token 过期时间
