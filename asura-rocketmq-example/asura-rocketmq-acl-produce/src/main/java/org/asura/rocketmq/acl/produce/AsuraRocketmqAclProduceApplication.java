package org.asura.rocketmq.acl.produce;
...
public class AsuraRocketmqAclProduceApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(AsuraRocketmqAclProduceApplication.class, args);
    }
